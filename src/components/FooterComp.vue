<template>
    <footer class="py-5">
        <div class="container d-flex gap-5">
            <div class="left d-flex align-items-center flex-column justify-content-between gap-5">
                <svg class="logo" xmlns="http://www.w3.org/2000/svg" width="146" height="24">
                ...
                <div class="socials d-flex algin-items-center gap-md-3 gap-4">
            ...
            <div class="links d-flex align-items-start px-5 justify-content-between flex-fill">
                <ul class="first d-flex align-items-start flex-column gap-2">
                    <li>Home</li>
                    <li>Pricing</li>
                    <li>Products</li>
                    <li>About Us</li>
                </ul>
                <ul class="last d-flex align-items-start flex-column gap-2">
                    <li>Careers</li>
                    <li>Community</li>
                    <li>Privacy Policy</li>
                </ul>
            </div>
            <div class="right d-flex align-items-end flex-column justify-content-between gap-5">
                <form class="d-flex position-relative" @submit.prevent="submission">
                    <div class="position-relative">
                        <input :class="`rounded-pill px-4 me-2 h-100 ${validation.$error ? 'err' : ''}`" type="text"
                            placeholder="Updates in Your inbox..." v-model="inputText.email">
                        <span v-if="validation.$error" v-text="validation.$errors[0].$validator === 'required' ? 'Field can\'t be empty' : 'Please insert a valid email' " class="error d-block fst-italic ms-3 text-danger position-absolute"></span>
                    </div>
                    <button @click.stop="" class="butn">Go</button>
                </form>
...
const validation = useVuelidate(rules, inputText)
